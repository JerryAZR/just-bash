...
function runCli(
  ...
  // execFileSync with an argv array (no shell) keeps script arguments
  // intact on win32, where cmd.exe would otherwise treat the single quotes
  // around -c scripts as literal characters.
  try {
